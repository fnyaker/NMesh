...
66 findings, 46 security and 20 performance, all addressed. Five are recorded
...
that has not yet joined), not an unfinished patch. The last one was not found by
reading the code — CI found it when the base image's Python moved to 3.13.
