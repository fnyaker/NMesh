...
Source of truth: `src/packet.py`, `src/src/mesh/messages.py` (the type table),
`src/src/mesh/constants.py` (the bounds), `src/node.py` (`_handle_packet`).
...
## Type table (`src/src/mesh/messages.py`)
